...
//    NPMUser *user = [_friends objectAtIndex:sourceIndexPath.row];
//    [_friends removeObjectAtIndex:sourceIndexPath.row];
//    [_friends insertObject:user atIndex:destinationIndexPath.row];
...
//        NPMUser *user = [_friends objectAtIndex:row];
//        [NPMBackendTools removeUser:user];
//        [_friends removeObjectAtIndex:row];
